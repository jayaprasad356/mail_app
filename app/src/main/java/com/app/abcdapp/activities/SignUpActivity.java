...
public class SignUpActivity extends AppCompatActivity {
    ...
    EditText EtName,EtOtp, EtPhoneNo, edDOB, EtEmail, EtCity, EtCode, EtPassword;
    LinearLayout llDob;
    ImageView backbtn;
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (EtName.getText().toString().trim().equals("")) {
                    ...
                    Toast.makeText(SignUpActivity.this, "Phone Number is empty", Toast.LENGTH_SHORT).show();
                } else if (!EtOtp.getText().toString().trim().equals(randomnumber + "")) {
                    Toast.makeText(SignUpActivity.this, "Otp is wrong", Toast.LENGTH_SHORT).show();
